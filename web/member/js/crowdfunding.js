...
$("#listClick19").attr("class","");
	}

	if(value == 2){

		$("#crowdfunding_iframe").attr("src","make_head.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 3){
		...
		$("#crowdfunding_iframe").attr("src","identity_prove.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 4){
		...
		$("#crowdfunding_iframe").attr("src","make_password.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 5){
		...
		$("#crowdfunding_iframe").attr("src","apply_lingtou.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 6){
		...
		$("#crowdfunding_iframe").attr("src","project_manage.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 7){
		...
		$("#crowdfunding_iframe").attr("src","touhou_manage.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 8){
		...
		$("#crowdfunding_iframe").attr("src","my_account.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 9){
		...
		$("#crowdfunding_iframe").attr("src","investment_inquiry.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 10){
		...
		$("#crowdfunding_iframe").attr("src","apply_refund.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 11){
		...
		$("#crowdfunding_iframe").attr("src","grade_integration.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 12){
		...
		$("#crowdfunding_iframe").attr("src","integration_record.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 13){
		...
		$("#crowdfunding_iframe").attr("src","integration_rule.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 14){
		...
		$("#crowdfunding_iframe").attr("src","messages.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 15){
		...
		$("#crowdfunding_iframe").attr("src","inbox.html");
...
$("#listClick19").attr("class","");
	...
	if(value == 16){
		...
		$("#crowdfunding_iframe").attr("src","outbox.html");
	...
	if(value == 19){
		...
		$("#crowdfunding_iframe").attr("src","addnews.html");
		...
		$("#listClick16").attr("class","");
		$("#listClick19").attr("class","menu_list_on");
