...
function listClick(value){
	...
	if(value == 1){
		...
		$("#crowdfunding_iframe", window.parent.document).attr("src","my_info.html");
	...
	if(value == 3){
		...
		$("#crowdfunding_iframe", window.parent.document).attr("src","identity_prove.html");
	...
	if(value == 4){
		...
		$("#crowdfunding_iframe", window.parent.document).attr("src","make_password.html");
	...
	if(value == 11){
		...
		$("#crowdfunding_iframe", window.parent.document).attr("src","grade_integration.html");
	...
	if(value == 12){
		...
		$("#crowdfunding_iframe", window.parent.document).attr("src","integration_record.html");
	...
	if(value == 13){
		...
		$("#crowdfunding_iframe", window.parent.document).attr("src","integration_rule.html");
